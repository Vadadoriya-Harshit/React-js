  ...
  return (
    <div>
      ...
      <Row className="border">
        ...
        <Form.Control aria-label="Dollar amount (with dot and two decimal places)" placeholder='Where are you gong ?' value={freshVal} onChange={(e)=>setfreshVal(e.target.value)} />
        <InputGroup.Text>
