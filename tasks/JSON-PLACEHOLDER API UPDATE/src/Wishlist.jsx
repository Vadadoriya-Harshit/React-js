...
function Wishlist() {
  return (
    <section className="h-100" style={{ backgroundColor: '#eee',overflowY:'scroll', }}>
        <div className="container h-100 py-5 overflow-scroll">
        <div className="row d-flex justify-content-center align-items-center h-100">
          <div className="col-10">
            ...
            {/* Replace the following card sections with your wishlist items */}
